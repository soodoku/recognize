...
#' @export
#' @examples \dontrun{
#' compare_all(path_to_ocr="path_to_ocr_file", path_to_gold="path_to_gold_file", 
#' 	           remove_extra_space=TRUE)
#' }

compare_all <- function(path_to_ocr=NULL, path_to_gold=NULL, remove_extra_space=TRUE, normalize=TRUE) 
{
